...
func TestMCPListsAndCallsEveryAPISurface(t *testing.T) {
	...
	wantTools := map[string]bool{
		...
		"adb_clear_package": true, "adb_enable_package": true, "adb_disable_package": true,
		"adb_uninstall_package": true, "adb_screenshot": true, "adb_logs": true,
		"adb_reboot": true, "install_apk": true,
	}
